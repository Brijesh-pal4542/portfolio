...
function Navbar() {
  ...
  return (
    <div className="flex flex-wrap justify-between h-12 w-full md:h-13">
      ...
      <div className="flex h-full w-[60%] md:min-w-175 bg-[#800020c9] p-1 rounded-full font-extrabold shadow-sm shadow-amber-800">
        <img
          className="h-full w-10 mr-0.5 md:w-13 rounded-full border-2"
          src="logo_B.jpg"
          alt=""
        ></img>
        <div className="md:hidden flex justify-center py-1.5 h-full w-full bg-[#800020c9] rounded-full border-2 shade cursor-pointer">
          Brijesh Pal
        </div>
      ...
      <button
        ...
        className="md:hidden text-2xl font-bold h-full bg-amber-900 opacity-90 p-1 rounded cursor-pointer shade hover:bg-amber-700 duration-700"
      >
        &#9776;
      </button>
