...
function Hero() {
  ...
  return (
    <div className="h-150 w-full mt-5 dot-grid  md:flex px-5">
      <div className="flex max-md:justify-center md:items-center h-[50%] md:h-full md:m-10 p-1 bg-amber-700 rounded-full dot-grid">
        <img
          className="h-full rounded-full md:h-[90%]"
          src={hero_image}
          alt=""
        />
      </div>
      <div className="flex flex-col max-md:text-center md:justify-center h-[50%] w-full md:h-full md:w-[50%] max-md:mt-3 md:ml-10">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold text-amber-950">
          I'm Brijesh Pal,
        </h1>
